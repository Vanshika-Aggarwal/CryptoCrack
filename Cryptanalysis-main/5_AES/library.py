...
input_file = open("Data/plaintexts.txt", 'r')
output_file = open("Data/arrange_out.txt", 'r')
...
for index in range(6):
    ...
    inp = open("Data/plaintexts.txt", 'r')
    out = open("Data/arrange_out.txt", 'r')
...
print("\nExponent vector E is :\n")
print(exp_list)
print("\n")

#Final Matrices as we found them in above step
LINEAR_MATRIX = [[84, 112, 19, 98, 110, 28, 2, 95], [0, 70, 30, 16, 62, 50, 123, 2], [0, 0, 43, 31, 1, 19, 9, 74], [0, 0, 0, 12, 123, 43, 103, 27], [0, 0, 0, 0, 112, 99, 29, 25], [0, 0, 0, 0, 0, 11, 88, 71], [0, 0, 0, 0, 0, 0, 27, 30], [0, 0, 0, 0, 0, 0, 0, 38]]

EXPONENT_MATRIX = [22, 113, 38, 73, 92, 55, 19, 26]